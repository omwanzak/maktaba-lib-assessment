...
export default function Home() {
  const fullText = "Maktaba Library System is your gateway to a modern, digital library experience. Discover, borrow, and manage books with ease. Our platform is designed for readers, librarians, and administrators to collaborate and enjoy seamless access to resources.";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl w-full flex flex-col items-center gap-8 z-10"> {/* z-index to bring content above overlay */}
        <h1 className="text-6xl font-extrabold mb-4 tracking-tight text-white text-shadow-lg animate-fade-in-scale">Maktaba Library System</h1>
        <section className="bg-opacity-20 text-white rounded-lg shadow p-6 w-full animate-slide-up"> 
          <p className="text-lg text-white">
            {mainText} {
              visibleWords.map((word, index) => (
                <span key={index} className="inline-block opacity-0 animate-fade-in-word" style={{ animationDelay: `${index * 0.2}s` }}>
